...
g++ -std=c++11 -shared -o sub_conv2d.so sub_conv2d.cc ${TF_CFLAGS[@]} -fPIC ${TF_LFLAGS[@]} -O3 -march=native -D_GLIBCXX_USE_CXX11_ABI=0 -D GOOGLE_CUDA=1 -I/usr/local/cuda/targets/x86_64-linux/include -L/usr/local/cuda-10.0/targets/x86_64-linux/lib
